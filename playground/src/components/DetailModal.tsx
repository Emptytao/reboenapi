...
import { getApiProfileForMode } from '../lib/apiProfiles'
...
export default function DetailModal() {
  ...
  const codexCliPromptKey = getCodexCliPromptKey(settings, 'gallery')
  const hasHandledPromptWarning = getApiProfileForMode(settings, 'gallery').codexCli || dismissedCodexCliPrompts.includes(codexCliPromptKey)
