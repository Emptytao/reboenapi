...
const (
	...
	ChannelTypeCodex          = 57
	ChannelTypeHKCOPP         = 58
	ChannelTypeSpottedFrog    = 59
...
var ChannelBaseURLs = []string{
	...
	"https://api.hkcopp.online/openapi/v1",      //58
	"https://api.hellobabygo.com",               //59
}
...
var ChannelTypeNames = map[int]string{
	...
	ChannelTypeHKCOPP:         "HKCOPP",
	ChannelTypeSpottedFrog:    "SpottedFrog",
}
